...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, x, y, postion):
        ...
        self.rect = self.image.get_rect()
        #postion 1 is from top, -1 is from bottom
        if postion == 1:
...
button = Button(screen_width // 2 - 50, screen_height // 1.7 - 100, button_img)
...
while run:
    ...
    draw_text(str(score), font, white, int(screen_width / 1.3), 20)
